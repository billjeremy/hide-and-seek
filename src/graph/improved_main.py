...
def main(n_arbo: int = 10, n_copy: int = 10, output_path: str = "env_test_complet") -> None:
    """Main entry point. Parameters allow easy testing.

    Defaults match previous behavior; for smoke tests pass smaller values.
    """
